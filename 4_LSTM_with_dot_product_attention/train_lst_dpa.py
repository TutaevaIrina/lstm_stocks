...
from lstm_dot_product_attention import LSTMModelWithAttention

torch.manual_seed(0)

model_base_name = "LSTMModelWithAttention" # for storage later
...
num_epochs = 10
learning_rate = 0.001
model = LSTMModelWithAttention(input_size = input_size, hidden_size=128, num_layers=2, output_size=1, dropout_prob=0.2).to(device)
